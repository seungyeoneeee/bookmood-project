...
const WishlistManager: React.FC<WishlistManagerProps> = ({
  ...
  useEffect(() => {
    const mockWishlist: WishlistBook[] = [{
      ...
      tags: ['개발', '코딩', '실무'],
      notes: '팀 리더가 추천한 필독서',
      mpid: "895c5754-5244-4041-908f-304ce26a7cde"
    }, {
      id: '2',
      title: '사피엔스',
      author: '유발 하라리',
      ...
      tags: ['역사', '인문학', '철학'],
      notes: '친구가 강력 추천',
      mpid: "8e338d6e-88cc-43e4-8d6b-3840caa46ff0"
    }, {
      id: '3',
      title: '원피스 1권',
      author: '오다 에이치로',
      ...
      tags: ['만화', '모험', '우정'],
      notes: '휴식용 독서',
      mpid: "ff78c9de-7853-4c57-84a6-e604c347db71"
    }, {
      id: '4',
      title: '데미안',
      author: '헤르만 헤세',
      ...
      mpid: "6d224d88-8d10-46f8-be77-77c7bdee7065"
    }, {
      id: '5',
      title: '아토믹 해빗',
      author: '제임스 클리어',
      ...
      tags: ['습관', '자기계발', '실용'],
      notes: '새해 목표 달성을 위해',
      mpid: "f47c7f6a-ef1b-47bf-83a9-c2b674995a6d"
    }];
