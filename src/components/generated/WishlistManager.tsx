...
const WishlistManager: React.FC<WishlistManagerProps> = ({
  ...
  useEffect(() => {
    const mockWishlist: WishlistBook[] = [{
      ...
      tags: ['개발', '코딩', '실무'],
      notes: '팀 리더가 추천한 필독서',
      mpid: "4da7f6bb-fcf7-4e64-a456-69c8e9b8f105"
    }, {
      id: '2',
      title: '사피엔스',
      author: '유발 하라리',
      ...
      tags: ['역사', '인문학', '철학'],
      notes: '친구가 강력 추천',
      mpid: "81f22634-016f-4fb1-a301-8840c16dc84b"
    }, {
      id: '3',
      title: '원피스 1권',
      author: '오다 에이치로',
      ...
      tags: ['만화', '모험', '우정'],
      notes: '휴식용 독서',
      mpid: "4d4834d3-ee3a-48e1-bef2-06fd9304fb61"
    }, {
      id: '4',
      title: '데미안',
      author: '헤르만 헤세',
      ...
      mpid: "f9c3b692-fc02-40b5-97b8-39d399ff63c0"
    }, {
      id: '5',
      title: '아토믹 해빗',
      author: '제임스 클리어',
      ...
      tags: ['습관', '자기계발', '실용'],
      notes: '새해 목표 달성을 위해',
      mpid: "365a97a7-d05b-4615-8e1d-a057ab6ef479"
    }];
