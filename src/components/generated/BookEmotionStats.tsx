...
const BookEmotionStats: React.FC<BookEmotionStatsProps> = ({
  ...
  const tabs = [{
    ...
    label: '개요',
    icon: Target,
    mpid: "f7c296dc-5315-4150-a6a4-820ba5e7c74a"
  }, {
    id: 'emotions',
    label: '감정',
    icon: Heart,
    mpid: "8f04cd44-f031-4e2b-bd8a-efb65e521286"
  }, {
    id: 'trends',
    label: '트렌드',
    icon: TrendingUp,
    mpid: "af98c951-98aa-4276-b2a7-91217d1ef818"
  }, {
    id: 'reviews',
    label: '리뷰',
    icon: Users,
    mpid: "05fb1564-14f7-4c40-9c47-884136ff1543"
  }] as any[];
