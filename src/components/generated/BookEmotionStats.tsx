...
const BookEmotionStats: React.FC<BookEmotionStatsProps> = ({
  ...
  const tabs = [{
    ...
    label: '개요',
    icon: Target,
    mpid: "d6abf211-be22-4789-b566-02a57d61e1b5"
  }, {
    id: 'emotions',
    label: '감정',
    icon: Heart,
    mpid: "4dd19ba0-0187-4e48-840d-8f285367408c"
  }, {
    id: 'trends',
    label: '트렌드',
    icon: TrendingUp,
    mpid: "904a347b-4df9-4c31-9499-b6ab1cce4065"
  }, {
    id: 'reviews',
    label: '리뷰',
    icon: Users,
    mpid: "0dff9a27-6054-4b65-8c46-3a933ff476cf"
  }] as any[];
