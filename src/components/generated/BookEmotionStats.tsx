...
const BookEmotionStats: React.FC<BookEmotionStatsProps> = ({
  ...
  const tabs = [{
    ...
    label: '개요',
    icon: Target,
    mpid: "260e5c73-4a88-449d-ac3e-b583300e8030"
  }, {
    id: 'emotions',
    label: '감정',
    icon: Heart,
    mpid: "f9b0afe4-2860-4008-b3e5-57717ab924cc"
  }, {
    id: 'trends',
    label: '트렌드',
    icon: TrendingUp,
    mpid: "8b92bb60-793e-48d7-9c23-ce11a678a044"
  }, {
    id: 'reviews',
    label: '리뷰',
    icon: Users,
    mpid: "90b0d7e0-3807-40cf-8856-49858bc231dd"
  }] as any[];
