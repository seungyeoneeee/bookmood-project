...
import { Search, ArrowLeft, Book, Star, User, Calendar, Sparkles, Send, Loader2, X, BookOpen } from 'lucide-react';
interface BookData {
  id: string;
  title: string;
  author: string;
...
const BookSearchFlow: React.FC<BookSearchFlowProps> = ({
  ...
  const mockBooks: BookData[] = [{
    ...
    publishedYear: '2020',
    rating: 4.5,
    mpid: "54be848f-360f-4b44-b3f5-e7e3aa44fb88"
  }, {
    id: '2',
    title: '아몬드',
    author: '손원평',
    ...
    publishedYear: '2017',
    rating: 4.7,
    mpid: "3ab515b6-a86b-4aea-b00c-f1c33c0f350b"
  }, {
    id: '3',
    title: '미드나이트 라이브러리',
    author: '매트 헤이그',
    ...
    publishedYear: '2020',
    rating: 4.3,
    mpid: "da3669b7-59fa-4f59-9e25-cdd474243b6e"
  }];
    ...
    y: -20
      ...
      <div className="max-w-sm mx-auto" data-magicpath-id="1" data-magicpath-path="BookSearchFlow.tsx">
        ...
        y: 0
            ...
            <h2 className="text-lg font-semibold text-gray-800 mb-4" data-magicpath-id="17" data-magicpath-path="BookSearchFlow.tsx">검색 결과</h2>
          ...
          delay: index * 0.1
        }} onClick={() => handleBookSelect(book)} className="bg-white border border-gray-200 rounded-2xl p-4 active:scale-95 transition-transform shadow-sm hover:shadow-md" data-magicpath-uuid={(book as any)["mpid"] ?? "unsafe"} data-magicpath-id="18" data-magicpath-path="BookSearchFlow.tsx">
                <div className="flex space-x-4" data-magicpath-uuid={(book as any)["mpid"] ?? "unsafe"} data-magicpath-id="19" data-magicpath-path="BookSearchFlow.tsx">
                  <img src={book.cover} alt={book.title} className="w-16 h-24 object-cover rounded-xl shadow-sm" data-magicpath-uuid={(book as any)["mpid"] ?? "unsafe"} data-magicpath-field="cover:unknown" data-magicpath-id="20" data-magicpath-path="BookSearchFlow.tsx" />
                  <div className="flex-1" data-magicpath-uuid={(book as any)["mpid"] ?? "unsafe"} data-magicpath-id="21" data-magicpath-path="BookSearchFlow.tsx">
                    <h3 className="font-semibold text-gray-800 mb-1 text-sm" data-magicpath-uuid={(book as any)["mpid"] ?? "unsafe"} data-magicpath-field="title:unknown" data-magicpath-id="22" data-magicpath-path="BookSearchFlow.tsx">
                      {book.title}
                    </h3>
                    <p className="text-gray-600 text-xs mb-2" data-magicpath-uuid={(book as any)["mpid"] ?? "unsafe"} data-magicpath-field="author:unknown" data-magicpath-id="23" data-magicpath-path="BookSearchFlow.tsx">
                      {book.author}
                    </p>
                    {book.rating && <div className="flex items-center mb-2" data-magicpath-uuid={(book as any)["mpid"] ?? "unsafe"} data-magicpath-id="24" data-magicpath-path="BookSearchFlow.tsx">
                        ...
                        <span className="text-gray-600 text-xs" data-magicpath-uuid={(book as any)["mpid"] ?? "unsafe"} data-magicpath-field="rating:unknown" data-magicpath-id="26" data-magicpath-path="BookSearchFlow.tsx">{book.rating}</span>
                      </div>}
                    <p className="text-gray-500 text-xs line-clamp-2" data-magicpath-uuid={(book as any)["mpid"] ?? "unsafe"} data-magicpath-field="description:unknown" data-magicpath-id="27" data-magicpath-path="BookSearchFlow.tsx">
                      {book.description}
                    </p>
                  </div>
                </div>
        ...
        opacity: 1
            ...
            <BookOpen className="w-16 h-16 text-gray-300 mx-auto mb-4" data-magicpath-id="29" data-magicpath-path="BookSearchFlow.tsx" />
            <h3 className="text-lg font-semibold text-gray-800 mb-2" data-magicpath-id="30" data-magicpath-path="BookSearchFlow.tsx">검색 결과가 없습니다</h3>
            <p className="text-gray-600" data-magicpath-id="31" data-magicpath-path="BookSearchFlow.tsx">다른 키워드로 검색해보세요</p>
          </motion.div>}
      </div>
    </motion.div>;
  const renderBookDetailStep = () => <motion.div initial={{
    ...
    opacity: 0,
    x: -20
  }} className="min-h-screen px-4 py-8" data-magicpath-id="32" data-magicpath-path="BookSearchFlow.tsx">
      <div className="max-w-sm mx-auto" data-magicpath-id="33" data-magicpath-path="BookSearchFlow.tsx">
        ...
        <div className="flex items-center justify-between mb-8" data-magicpath-id="34" data-magicpath-path="BookSearchFlow.tsx">
          <button onClick={() => setCurrentStep('search')} className="w-10 h-10 bg-gray-100 rounded-xl flex items-center justify-center hover:bg-gray-200 transition-colors" data-magicpath-id="35" data-magicpath-path="BookSearchFlow.tsx">
            <ArrowLeft className="w-5 h-5 text-gray-600" data-magicpath-id="36" data-magicpath-path="BookSearchFlow.tsx" />
          </button>
          <h1 className="text-xl font-bold text-gray-800" data-magicpath-id="37" data-magicpath-path="BookSearchFlow.tsx">책 정보</h1>
          <div className="w-10" data-magicpath-id="38" data-magicpath-path="BookSearchFlow.tsx" />
        </div>

        {selectedBook && <div className="bg-white border border-gray-200 rounded-2xl p-6 mb-8 shadow-sm" data-magicpath-id="39" data-magicpath-path="BookSearchFlow.tsx">
            <div className="text-center mb-6" data-magicpath-id="40" data-magicpath-path="BookSearchFlow.tsx">
              ...
              <h1 className="text-xl font-bold text-gray-800 mb-2" data-magicpath-id="42" data-magicpath-path="BookSearchFlow.tsx">{selectedBook.title}</h1>
              <p className="text-gray-600 mb-4" data-magicpath-id="43" data-magicpath-path="BookSearchFlow.tsx">{selectedBook.author}</p>
              ...
              <div className="flex items-center justify-center space-x-4 mb-4" data-magicpath-id="44" data-magicpath-path="BookSearchFlow.tsx">
                {selectedBook.publishedYear && <div className="flex items-center text-gray-500" data-magicpath-id="45" data-magicpath-path="BookSearchFlow.tsx">
                ...
                {selectedBook.rating && <div className="flex items-center" data-magicpath-id="48" data-magicpath-path="BookSearchFlow.tsx">
                    ...
                    <span className="text-gray-600 text-sm" data-magicpath-id="50" data-magicpath-path="BookSearchFlow.tsx">{selectedBook.rating}/5</span>
                  </div>}
              </div>
            </div>

            <p className="text-gray-600 text-sm leading-relaxed mb-6 text-center" data-magicpath-id="51" data-magicpath-path="BookSearchFlow.tsx">
              {selectedBook.description}
            </p>

            <button onClick={handleProceedToReview} className="w-full py-4 bg-gradient-to-r from-[#B5D4C8] to-[#A8D4C8] text-white rounded-2xl font-medium flex items-center justify-center space-x-2 shadow-lg hover:shadow-xl transition-shadow" data-magicpath-id="52" data-magicpath-path="BookSearchFlow.tsx">
  ...
  const renderReviewStep = () => <motion.div initial={{
    ...
    opacity: 0,
    x: -20
  }} className="min-h-screen px-4 py-8" data-magicpath-id="54" data-magicpath-path="BookSearchFlow.tsx">
      <div className="max-w-sm mx-auto" data-magicpath-id="55" data-magicpath-path="BookSearchFlow.tsx">
        ...
        <div className="flex items-center justify-between mb-8" data-magicpath-id="56" data-magicpath-path="BookSearchFlow.tsx">
          <button onClick={() => setCurrentStep('book-detail')} className="w-10 h-10 bg-gray-100 rounded-xl flex items-center justify-center hover:bg-gray-200 transition-colors" data-magicpath-id="57" data-magicpath-path="BookSearchFlow.tsx">
            <ArrowLeft className="w-5 h-5 text-gray-600" data-magicpath-id="58" data-magicpath-path="BookSearchFlow.tsx" />
          </button>
          <h1 className="text-xl font-bold text-gray-800" data-magicpath-id="59" data-magicpath-path="BookSearchFlow.tsx">감상문 작성</h1>
          <div className="w-10" data-magicpath-id="60" data-magicpath-path="BookSearchFlow.tsx" />
        </div>

        {selectedBook && <div className="bg-white border border-gray-200 rounded-2xl p-4 mb-6 shadow-sm" data-magicpath-id="61" data-magicpath-path="BookSearchFlow.tsx">
            <div className="flex items-center space-x-3" data-magicpath-id="62" data-magicpath-path="BookSearchFlow.tsx">
              <img src={selectedBook.cover} alt={selectedBook.title} className="w-12 h-18 object-cover rounded-lg shadow-sm" data-magicpath-id="63" data-magicpath-path="BookSearchFlow.tsx" />
              <div data-magicpath-id="64" data-magicpath-path="BookSearchFlow.tsx">
                <h3 className="font-semibold text-gray-800 text-sm" data-magicpath-id="65" data-magicpath-path="BookSearchFlow.tsx">{selectedBook.title}</h3>
                <p className="text-gray-600 text-xs" data-magicpath-id="66" data-magicpath-path="BookSearchFlow.tsx">{selectedBook.author}</p>
              </div>
            </div>
          </div>}

        <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm" data-magicpath-id="67" data-magicpath-path="BookSearchFlow.tsx">
          <label className="block text-sm font-medium text-gray-800 mb-4" data-magicpath-id="68" data-magicpath-path="BookSearchFlow.tsx">
            이 책을 읽고 느낀 감정을 자유롭게 적어주세요
          </label>
          <textarea value={reviewText} onChange={e => setReviewText(e.target.value)} placeholder="이 책을 읽으면서 어떤 감정을 느꼈나요? 어떤 장면이 가장 인상 깊었나요? 자유롭게 감상을 적어주세요..." className="w-full h-40 px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-800 placeholder-gray-400 focus:outline-none focus:border-[#A8B5E8] focus:ring-2 focus:ring-[#A8B5E8]/20 resize-none text-sm" data-magicpath-id="69" data-magicpath-path="BookSearchFlow.tsx" />
          
          <div className="mt-6" data-magicpath-id="70" data-magicpath-path="BookSearchFlow.tsx">
            <p className="text-xs text-gray-500 mb-4 text-center" data-magicpath-id="71" data-magicpath-path="BookSearchFlow.tsx">
              AI가 당신의 감상을 분석해서 감성 카드를 만들어드려요
            </p>
            <button onClick={handleSubmitReview} disabled={!reviewText.trim() || isSubmitting} className="w-full py-4 bg-gradient-to-r from-[#F4E4B8] to-[#F0E4B8] text-white rounded-2xl font-medium disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2 shadow-lg hover:shadow-xl transition-shadow" data-magicpath-id="72" data-magicpath-path="BookSearchFlow.tsx">
              {isSubmitting ? <>
